...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ', url='https://t.me/POPCORN_GRP'),
            InlineKeyboardButton('♚ ᴏᴡɴᴇʀ ♚', url='https://t.me/MALAYALI_DUDE')
            ],[      
            InlineKeyboardButton('〄 ʜᴇʟᴘ 〄', callback_data='help'),
            InlineKeyboardButton('⍟ ᴀʙᴏᴜᴛ ⍟', callback_data='about')
            ],[
            InlineKeyboardButton('⌬ sᴜᴘᴘᴏʀᴛ ⌬', url='https://t.me/ABOUT_SMP')
        ]]         
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇᴘᴏ', url='https://github.com/GYPZYTECHS'),
        ...
        buttons = [[
           InlineKeyboardButton('ʀᴇᴘᴏ', url='https://github.com/GYPZYTECHS'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/ABOUT_SMP')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='czdbots')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
